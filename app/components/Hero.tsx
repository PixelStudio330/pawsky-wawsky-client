...
export default function Hero() {
  ...
  return (
    <section className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] bg-[#FFFFF7] pt-32 pb-36 md:pt-44 md:pb-44 lg:pb-52 flex items-center overflow-hidden min-h-[640px] md:h-screen max-h-[850px] z-10 m-0 p-0">
      ...
      {/* BACKGROUND LAYER 2 - FLOATING LEAVES */}
      <motion.div 
        animate={{ 
          y: [0, -14, 8, -6, 0],
          x: [0, 6, -5, 4, 0],
      ...
      {/* HERO CONTENT AREA */}
      <div className="w-full max-w-7xl mx-auto px-6 sm:px-12 md:px-16 lg:px-24 xl:px-32 z-20 relative mt-6 md:mt-0">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center w-full">
          ...
          <motion.div 
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-md md:max-w-xl mx-auto lg:mx-0 lg:col-span-7 xl:-ml-12"
          >
            {/* Rating Note */}
            <motion.div 
          ...
          {/* Right Content Side - FULLY RESPONSIVE SWING PAW */}
          <div className="col-span-1 lg:col-span-5 flex justify-center items-center relative z-20 w-full mt-4 lg:mt-0 lg:pl-8">
            <div 
              className="w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full border-4 border-[#FFF0ED]/80 bg-[#FFF0ED]/40 backdrop-blur-md shadow-[0_15px_35px_rgba(166,124,82,0.12)] flex items-center justify-center p-4 sm:p-6 md:p-8 origin-top animate-[paw-swing_3.5s_ease-in-out_infinite] select-none pointer-events-none md:pointer-events-auto"
            >
